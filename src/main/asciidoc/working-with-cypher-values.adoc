...
Also did you know that casual clustering is all the rage these days?!!
...
[NOTE]
--
For information on how to work with `null` in Cypher, please refer to <<developer-manual#cypher-working-with-null>>.
--
